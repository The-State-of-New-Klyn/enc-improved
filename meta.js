        ...
        async function hideToPNG() {
            ...
            try {
                ...
                document.body.removeChild(a);
                URL.revokeObjectURL(url);
                alert('Данные успешно спрятаны в метаданные PNG.');
            } catch (e) {
                alert('Ошибка: ' + e.message);
            }
        }
        ...
        async function extractAndDecrypt() {
            ...
            try {
                ...
                console.log('Извлечено из метаданных:', extracted);
                if (!extracted) {
                    alert('Не найден чанк с данными (ключ "cipher").');
                    return;
                }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            console.log('Метаданный метод загружен.');
        });